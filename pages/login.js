			...
			<Layout>
				...
				<div className="flex justify-center mt-5">
					<div className="w-full max-w-sm">
						...
						>
							<div>
								{/* <label className="block text-sm leading-5 font-medium text-gray-700" htmlFor="email">
                                    E-mail
                                </label> */}
							...
							<div>
								{/* <label className="block text-sm leading-5 font-medium text-gray-700" htmlFor="password">
                                    Contraseña
                                </label> */}
								<input
									className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:shadow-outline-blue focus:border-orange-300 focus:z-10 sm:text-sm sm:leading-5"
							...
							<input
								type="submit"
								className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-orange-600 hover:bg-orange-500 focus:outline-none focus:border-orange-700 focus:shadow-outline-orange active:bg-orange-700 transition duration-150 ease-in-out mt-8"
